...
sont également présentées. Certaines de mes contributions apportant peu au rapport, par exemple certaines démonstrations, sont reléguées
en annexe.
...
\begin{proof}[Lemme \ref{2connstrictForbid}]
    ...
    similaire à la proposition : les chemins de $v_3, v_4$ à $v_2, v_5, v_6$ sont les arrêtes subdivisées de $H$
...
\begin{proof}[Proposition \ref{3connCompl}]
